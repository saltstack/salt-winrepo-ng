openoffice:
  '4.1.2':
    ...
    installer: 'http://iweb.dl.sourceforge.net/project/openofficeorg.mirror/4.1.2/binaries/en-US/Apache_OpenOffice_4.1.2_Win_x86_install_en-US.exe'
    install_flags: '/S'
  ...
  '4.1.1':
    ...
    installer: 'http://iweb.dl.sourceforge.net/project/openofficeorg.mirror/4.1.1/binaries/en-US/Apache_OpenOffice_4.1.1_Win_x86_install_en-US.exe'
    install_flags: '/S'
    uninstaller: 'msiexec.exe'
