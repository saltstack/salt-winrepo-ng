...
#
{% for star_version, guid, number in ( ('2020.05.1', '-15', '{4762F693-2C3A-4B0F-BC05-C3585669F7D7}'), 
                                           ...
                                           ('2017.10', '-8', '{C76048D0-CCE1-4B79-AB66-FF88B5105E99}'), 
                                           ('2017.07', '-7', '{4593B5F3-B1AE-4632-80ED-8DECC493A2C4}'), 
...
#
rakudo-star-{{ star_version }}_x64.sls:
  '{{ star_version }}':
