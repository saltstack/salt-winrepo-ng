firefox:
  ...
  {% endif %}
  {% for version in ['29.0.1', '35.0.1', '38.0.1', '38.0.5', '38.0.6', '39.0', '39.0.3', '40.0', '40.0.2', '40.0.3', '41.0', '41.0.1', '41.0.2', '42.0', '43.0', '43.0.1', '43.0.2', '43.0.3', '43.0.4', '44.0', '44.0.1', '44.0.2', '45.0', '45.0.1', '45.0.2', '46.0', '46.0.1', '47.0', '47.0.1', '48.0', '48.0.2', '49.0'] %}
  '{{ version }}':
