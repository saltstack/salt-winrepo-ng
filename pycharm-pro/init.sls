...
pycharm-pro:
  ...
  {{ build }}:
    ...
    install_flags: '/S /CONFIG="C:\ProgramData\Salt Project\salt\var\cache\salt\minion\files\base\win\repo-ng\salt-winrepo-ng_git\pycharm-pro\silent.config"'
    cache_file: salt://win/repo-ng/salt-winrepo-ng_git/pycharm-pro/silent.config
