...
{% set versions = {'7.0':[24], '6.0':[45], '5.2':[0,1,2,3,7], '5.0':[1,2,3,4,5,6,7,47], '4.4':[1,2,3,4,5,10], '4.2':[3,4,5,6,7,8], '4.0':[9,10,11,12,13,14,15,16,17,22,23,24,25,26,27,50], '3.0':[26,27,28,29,32]} %}
