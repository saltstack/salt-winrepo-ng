...
pass4win:
  '1.2.3.7':
    ...
    # both 32-bit (x86) AND a 64-bit (AMD64) installer available
    {% if grains['cpuarch'] == 'AMD64' %}
    installer: 'https://github.com/mbos/Pass4Win/releases/download/version-1.2.3/Pass4Win-Setup-v1.2.3.7-x64.exe'
    {% else %}
    installer: 'https://github.com/mbos/Pass4Win/releases/download/version-1.2.3/Pass4Win-Setup-v1.2.3.7-x86.exe'
    {% endif %}
