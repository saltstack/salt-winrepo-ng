keepass:
  ...
  '1.33.0':
    ...
    install_flags: '/qn /norestart'
    uninstaller: 'http://vorboss.dl.sourceforge.net/project/keepass/KeePass%201.x/1.33/KeePass-1.33.msi'
    uninstall_flags: '/qn /norestart'
    msiexec: True
    locale: en_US
    reboot: False
  '1.32.0':
    ...
    installer: 'http://vorboss.dl.sourceforge.net/project/keepass/KeePass%201.x/1.32/KeePass-1.32.msi'
    install_flags: '/qn /norestart'
    uninstaller: 'http://vorboss.dl.sourceforge.net/project/keepass/KeePass%201.x/1.32/KeePass-1.32.msi'
    uninstall_flags: '/qn /norestart'
    msiexec: True
    locale: en_US
    reboot: False
